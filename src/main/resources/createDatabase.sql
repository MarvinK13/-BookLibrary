...
CREATE TABLE members(name varchar(50),userId int auto_increment ,email varchar(30),birthday DATE,active ENUM('true','false') DEFAULT 'true',CONSTRAINT PRIMARY KEY (userId,email));
